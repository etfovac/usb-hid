...
namespace UsbHid.USB.Classes
{
    ...
    {
        public static event EventHandler<EventArgs<Message>> DeviceNotify;
        ...
        public bool RegisterForDeviceNotifications(IntPtr windowHandle1)
        {
            ...
            try
            {
                ...
                {
                    Debug.WriteLine(
                        "usbGenericHidCommunication:registerForDeviceNotifications() -> Notification registration succeed");
                    return true;
                }
            }
            catch (Exception ex)
            {
                Debug.WriteLine(
                    "usbGenericHidCommunication:registerForDeviceNotifications() -> EXCEPTION: An unknown exception has occurred!");
                Debug.WriteLine(ex.Message);
            }
            finally
            {
        ...
        public static bool IsNotificationForTargetDevice(Message m)
        {
            ...
            {
                Debug.WriteLine("usbGenericHidCommunication:isNotificationForTargetDevice() -> EXCEPTION: An unknown exception has occurred!");
                Debug.WriteLine(ex.Message);
                return false;
            }
            return false;
        ...
        public void HandleDeviceNotificationMessages(Message m)
        {
            ...
            {
                Debug.WriteLine("usbGenericHidCommunication:handleDeviceNotificationMessages() -> EXCEPTION: An unknown exception has occurred!");
                Debug.WriteLine(ex.Message);
            }
        }
